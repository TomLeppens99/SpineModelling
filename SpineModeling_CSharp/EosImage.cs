...
namespace SpineAnalyzer
{
    public class EosImage
    {
       public AppData AppData;
        ...
        {
            EvilDICOM.Core.Element.Tag tagPATIENT_NAME = EvilDICOM.Core.Helpers.TagHelper.PATIENT_NAME;
            EvilDICOM.Core.Element.Tag tagROWS = EvilDICOM.Core.Helpers.TagHelper.ROWS;
            EvilDICOM.Core.Element.Tag tagCOLUMNS = EvilDICOM.Core.Helpers.TagHelper.COLUMNS;
            EvilDICOM.Core.Element.Tag tagDISTANCE_SOURCE_TO_ISOCENTER = EvilDICOM.Core.Helpers.TagHelper.DISTANCE_SOURCE_TO_ISOCENTER;
            EvilDICOM.Core.Element.Tag tagDISTANCE_SOURCE_TO_DETECTOR = EvilDICOM.Core.Helpers.TagHelper.DISTANCE_SOURCE_TO_DETECTOR;
            EvilDICOM.Core.Element.Tag tagDISTANCE_SOURCE_TO_PATIENT = EvilDICOM.Core.Helpers.TagHelper.DISTANCE_SOURCE_TO_PATIENT;
            EvilDICOM.Core.Element.Tag tagIMAGER_PIXEL_SPACING = EvilDICOM.Core.Helpers.TagHelper.IMAGER_PIXEL_SPACING;
            EvilDICOM.Core.Element.Tag tagPIXEL_SPACING = EvilDICOM.Core.Helpers.TagHelper.PIXEL_SPACING;
            EvilDICOM.Core.Element.Tag tagPATIENT_ORIENTATION = EvilDICOM.Core.Helpers.TagHelper.PATIENT_ORIENTATION;
            EvilDICOM.Core.Element.Tag FIELD_OF_VIEW_ORIGIN = EvilDICOM.Core.Helpers.TagHelper.FIELD_OF_VIEW_ORIGIN;
            EvilDICOM.Core.Element.Tag IMAGE_COMMENTS = EvilDICOM.Core.Helpers.TagHelper.IMAGE_COMMENTS;
            ...
            //file.Close();
                ...
                var dcm = EvilDICOM.Core.DICOMObject.Read(_Directory);
