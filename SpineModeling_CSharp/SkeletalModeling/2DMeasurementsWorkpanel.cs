...
using evildicomCoreB = evildicomCore2.EvilDICOM.Core;
using EvilDICOM.RT;
      ...
      public  Boolean EllipseIsBeingDrawnIm2 = false;
        ...
        public void LoadImages()
        {
            ...
            if (false)
            {
                ...
                DICOMObject dcm1 = EvilDICOM.Core.DICOMObject.Read(EosImage1.Directory);
                dcmImage1 = new DICOMImage((EvilDICOM.Core.DICOMObject)dcm1);
                ...
                DICOMObject dcm2 = EvilDICOM.Core.DICOMObject.Read(EosImage2.Directory);
        ...
        private void btnMeasurments_Click(object sender, EventArgs e)
        {
            ...
            //  btn3D.PerformClick();
            frmMetrics frmMetrics = new frmMetrics();
        ...
        public void EquilizeHistograms()
        {
            ...
            Image<Bgr, Byte> MyEMGUImageBGR1 = new Image<Bgr, Byte>(masterImage1);
            Image<Gray, Byte> MyEMGUImage1 = MyEMGUImageBGR1.Convert<Gray, Byte>();
            ...
            Image<Bgr, Byte> MyEMGUImageBGR2 = new Image<Bgr, Byte>(masterImage2);
            Image<Gray, Byte> MyEMGUImage2 = MyEMGUImageBGR2.Convert<Gray, Byte>();

            MyEMGUImage2._EqualizeHist();
            pictureBox2.Image = (System.Drawing.Image)MyEMGUImage2.ToBitmap();
